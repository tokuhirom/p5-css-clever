...
def _convert(source, context=None):
...
CSS::Clever - funky css preprocessor dammit
...
and, based on python's CleverCSS 0.1 written by Armin Ronacher.

=head1 SEE ALSO

L<http://sandbox.pocoo.org/clevercss/>

=head1 LICENSE

BSD License, same as CleverCSS.
